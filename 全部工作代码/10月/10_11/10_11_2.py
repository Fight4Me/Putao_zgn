...
index_path = r'C:\Users\bnuzgn\Desktop\10_11\data_s_res'
save_path = r'C:\Users\bnuzgn\Desktop\10_11\test.txt'
...
out_put = ""
out_put=out_put+'dir_name'+'\t'+'num'+'\t'+str('wx_num')+'\t'+str('wx_accuracy')+'\t'+str('wx_completion')+'\t'+str('wx_fluency')+'\t'+str('wx_min')+'\t'+str('wx_max')+'\t'+str('wx_avg')+'\t'+str('wx_more')+'\t'+str('wx_less')+'\t'+str('wx_leven')+'\n'
...
#    print(wx_num,num,dir_name)
    ...
    wx_avg = total/tag_0
    out_put=out_put+dir_name+'\t'+str(num)+'\t'+str(wx_num)+'\t'+str(wx_accuracy)+'\t'+str(wx_completion)+'\t'+str(wx_fluency)+'\t'+str(wx_min)+'\t'+str(wx_max)+'\t'+str(wx_avg)+'\t'+str(wx_more)+'\t'+str(wx_less)+'\t'+str(wx_leven)+'\n'
